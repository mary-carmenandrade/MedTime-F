...
export default function Login({ setIsAuthenticated, navigation }) {
    ...
    const handleSignIn = () => {
        ...
        .catch((error) => {
            ...
            const errorMessage = "Ingrese correctamente sus datos";
            ...
            <ScrollView contentContainerStyle={{
                ...
                <BlurView intensity={100} style={styles.blurView}>
                    <View style={styles.login}>
                        ...
                        <View>
                            <Text style={{ fontSize: 17, fontWeight: '400', color: 'blue' }}>E-mail</Text>
                            <TextInput
                                style={styles.input}
                        ...
                        <View>
                            <Text style={{ fontSize: 17, fontWeight: '400', color: 'blue' }}>Contraseña</Text>
                            <TextInput
                                style={styles.input}
